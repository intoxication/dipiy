  ...
  describe '.level / .level_name' do
    ...
    context 'admin' do
      it 'should work' do
        ...
        expect(u1.level_name).to eq('administrator')
      end
    end
    ...
    context 'vip' do
      it 'should work' do
        ...
        expect(u1.level_name).to eq('Senior member')
      end
    end
    ...
    context 'blocked' do
      it 'should work' do
        ...
        expect(u1.level_name).to eq('Prohibit users')
      end
    end
    ...
    context 'newbie' do
      it 'should work' do
        ...
        expect(u1.level_name).to eq('Novice')
      end
    end
    ...
    context 'normal' do
      it 'should work' do
        ...
        expect(u1.level_name).to eq('member')
      end
    end
  end
