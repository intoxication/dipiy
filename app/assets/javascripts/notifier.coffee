class Notifier
  ...
  showTooltip: ->
    $('.breadcrumb').before("<div class='alert alert-info' id='notification-alert'><a href='#' id='link_enable_notifications' style='color:green'>Click here </a> to open the desktop reminder notification function. <a class='close' data-dismiss='alert' href='#'>×</a></div>")
