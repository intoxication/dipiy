module Admin
  class ApplicationsController < Admin::ApplicationController
    ...
    def create
      ...
      if @application.save
        redirect_to(admin_applications_path, notice: "Application Create success.")
      else
        render action: "new"
      end
    end
    ...
    def update
      if @application.update(params[:doorkeeper_application].permit!)
        redirect_to(admin_applications_path, notice: "Application update completed.")
      else
        render action: "edit"
      end
    end
    ...
    def destroy
      @application.destroy
      redirect_to(admin_applications_path, notice: "successfully deleted.")
    end
